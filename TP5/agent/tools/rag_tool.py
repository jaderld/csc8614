...
# Chemin vers la base Chroma du TP4 (ajuste si nécessaire)
    ...
    try:
        ...
        for i, d in enumerate(docs, start=1):
            ...
            evidence.append(EvidenceDoc(
                ...
                score=meta.get("score"), # Note: Chroma ne renvoie pas toujours le score par défaut
            ))
